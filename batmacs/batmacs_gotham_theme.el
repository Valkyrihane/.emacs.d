...
(gotham-set-faces
 '((default :foreground base6 :background base0)
   ...
   (mode-line :foreground base5 :background base0 :box nil)
   (mode-line-inactive :foreground base4 :background base0 :box nil)
   ...
   ;; show-paren-mode
   (show-paren-match :foreground base0 :background orange :inverse-video nil)
   (show-paren-mismatch :foreground base0 :background red :inverse-video nil)
